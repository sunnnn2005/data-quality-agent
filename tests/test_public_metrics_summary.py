...
def test_public_metrics_summary_keeps_resume_metrics_honest():
    ...
    assert payload["public_metrics"]["test_count"] == 250
    ...
    assert payload["verified_project_outcomes"]["community_issue_templates"] == 9
    assert payload["verified_project_outcomes"]["community_labels"] == 12
    assert payload["verified_project_outcomes"]["community_public_growth_channels"] == 11
    ...
    assert payload["verified_project_outcomes"]["public_traction_growth_channels"] == 21
    ...
    assert payload["verified_project_outcomes"]["resume_outcome_scoreboard_claimable_now"] == 6
    ...
    assert payload["verified_project_outcomes"]["ai_engineer_review_paths"] == 7
    assert payload["verified_project_outcomes"]["ai_engineer_review_questions"] == 6
    assert payload["verified_project_outcomes"]["ai_engineer_review_countable_conditions"] == 7

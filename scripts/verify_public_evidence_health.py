...
PUBLIC_CHECKS = [
    ...
    },
    {
        ...
        "expected_json": {"stars": 0, "forks": 1, "test_count": 252},
        "evidence_type": "json",
    },
    {
    ...
    },
    {
        ...
        "expected_json": {"project": "Data Quality Agent", "issue_template_count": 9, "label_count": 12},
    ...
    {
        "id": "real-model-run-request-pack",
        "url": "https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/real-model-run-request-pack.json",
        "expected_json": {
            "project": "Data Quality Agent",
            "current_real_model_runs": 0,
            "acceptance_condition_count": 8,
            "resume_unlock_count": 4,
        },
        "expected_text": "real_model_request_ready_not_claimable",
        "expected_texts": [
    ...
    {
        "id": "first-external-proof-action-sheet",
        "url": "https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/first-external-proof-action-sheet.json",
        "expected_json": {
            "project": "Data Quality Agent",
            "primary_target_metric": "ai_engineer_review_items",
            "current_accepted_external_evidence": 0,
            "current_github_stars": 0,
            "current_confirmed_external_users": 0,
            "reviewer_target_count": 3,
            "required_success_field_count": 6,
        },
        "expected_text": "first accepted external evidence item",
        "expected_texts": [
    ...
    {
        "id": "first-external-proof-action-sheet-page",
        "url": "https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/first-external-proof-action-sheet.html",
        "expected_text": "First External Proof Action Sheet",
        "expected_texts": [

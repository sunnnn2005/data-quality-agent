...
PUBLIC_CHECKS = [
    ...
    },
    {
        ...
        "expected_texts": ["external-run-evidence-packet", "136 passing CI tests", "accepted-evidence-rollup", "real-model-evidence-capture"],
        "evidence_type": "json",
    },
    {
        "id": "adoption-metrics",
        "url": "https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/adoption-metrics.json",
        "expected_json": {"stars": 0, "forks": 1, "test_count": 136},
        "evidence_type": "json",
    },
    {
        "id": "openapi-contract",

...
| --- | ---: | --- | --- | --- | --- |
| confirmed_external_users | 0 | `not_claimable_yet` | - | Needs a non-owner public reviewer issue that passes the external evidence gate. | [evidence](https://github.com/sunnnn2005/data-quality-agent/blob/main/docs/accepted-evidence-rollup.md) |
| external_feedback_items | 0 | `not_claimable_yet` | - | Needs accepted public feedback with permission to count and non-placeholder comments. | [evidence](https://github.com/sunnnn2005/data-quality-agent/blob/main/docs/accepted-evidence-rollup.md) |
| reproducible_feedback_items | 0 | `not_claimable_yet` | - | Needs reviewer-submitted command, URL, and observed-result evidence. | [evidence](https://github.com/sunnnn2005/data-quality-agent/blob/main/docs/accepted-evidence-rollup.md) |
...
| Github Stars | 0 |
| Github Forks | 1 |
| Github Views 14 Day | 0 |
| Github Unique Visitors 14 Day | 0 |
| Github Clones 14 Day | 0 |
| Github Unique Cloners 14 Day | 0 |
| Issue Count | 26 |
...
- `confirmed_external_users`: Needs a non-owner public reviewer issue that passes the external evidence gate.
- `external_feedback_items`: Needs accepted public feedback with permission to count and non-placeholder comments.
- `reproducible_feedback_items`: Needs reviewer-submitted command, URL, and observed-result evidence.

...
| `public-reviewer-call` | CI-verified public reviewer call | [Public reviewer call](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/public-reviewer-call.json) | The project opens a public call for 3 reviewer segments, 6 submission paths, 9 outreach tasks, and 24 evidence fields while keeping current outcome counts at zero. |
...
- Added deterministic report verification guardrails and 235 passing CI tests.

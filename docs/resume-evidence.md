...
- Added a CI-verified application evidence pack with 25 recruiter review links, verified outcome numbers, resume bullets, an email note, and an interview opening.
...
- Added deterministic report verification guardrails and 126 passing CI tests.

...
| `github-discovery-profile` | CI-verified GitHub discovery profile | [GitHub discovery profile](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/github-discovery-profile.json) | The project verifies 16 precise repository topics, public homepage metadata, 6 reviewer entrypoints, and the current zero-star baseline without claiming adoption. |
...
| `community-growth-baseline` | CI-verified community growth baseline | [Community growth baseline](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/community-growth-baseline.json) | The project verifies 8 issue templates, 7 configured labels, 9 public contribution or feedback channels, contribution guidance, public feedback entrypoints, and current public counts without claiming community adoption. |
...
| `public-traction-dashboard` | CI-verified public traction dashboard | [Public traction dashboard](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/public-traction-dashboard.json) | The project tracks 4 live project surfaces, 19 growth or review channels, 5 demo funnel steps, and 3 resume-upgrade rules without inflating current traction. |
| `star-growth-kit` | CI-verified star growth kit | [Star growth kit](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/star-growth-kit.json) | The project verifies 6 repo topics, 4 ethical growth actions, 4 resume-upgrade rules, GitHub traffic context, and the current 0-star baseline without inflating traction or converting traffic into user claims. |
...
| `reviewer-action-queue` | CI-verified reviewer action queue | [Reviewer action queue](https://github.com/sunnnn2005/data-quality-agent/blob/main/docs/reviewer-action-queue.md) | Eight concrete reviewer outreach tasks are mapped to five public evidence goals with privacy boundaries, permission-to-count rules, and zero contacted or completed reviews claimed. |
| `reviewer-outreach-execution-pack` | CI-verified reviewer outreach execution pack | [Reviewer outreach execution pack](https://github.com/sunnnn2005/data-quality-agent/blob/main/docs/reviewer-outreach-execution-pack.md) | Eight ready-to-send reviewer messages, eight follow-up rules, five public evidence goals, privacy boundaries, and permission-to-count rules are published with a zero sent or completed baseline. |
...
| `resume-outcome-action-checklist` | CI-verified resume outcome action checklist | [Resume outcome action checklist](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/resume-outcome-action-checklist.json) | The project converts blocked outcome goals into 5 concrete next actions with evidence paths, completion checks, zero accepted public evidence, and 8 not-sent outreach slots. |
| `reviewer-submission-hub` | CI-verified reviewer submission hub | [Reviewer submission hub](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/reviewer-submission-hub.json) | The project maps 6 evidence-gated outcome categories to public submission paths, 23 required evidence fields, and conservative counting rules while keeping zero-count outcome claims blocked. |
| `outcome-collection-page` | CI-verified public outcome collection page | [Outcome collection](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/outcome-collection.json) | The project publishes a public reviewer page with 5 next actions, 6 submission paths, 23 evidence fields, zero-count baselines, and privacy boundaries before any user, feedback, or GitHub-star claim is upgraded. |
| `public-reviewer-call` | CI-verified public reviewer call | [Public reviewer call](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/public-reviewer-call.json) | The project opens a public call for 3 reviewer segments, 6 submission paths, 8 outreach tasks, and 23 evidence fields while keeping current outcome counts at zero. |
...
- Added a CI-verified community growth baseline with 8 issue templates, 7 configured labels, 9 public contribution or feedback channels, contribution guidance, and honest current public counts.
...
- Added a CI-verified public traction dashboard with 4 live project surfaces, 19 growth or review channels, 5 tracked demo funnel steps, and 3 resume-upgrade rules.
...
- Added a CI-verified application evidence pack with 43 recruiter review links, verified outcome numbers, resume bullets, an email note, and an interview opening.
...
- Added a CI-verified pilot evidence quicklink with 3 short reviewer actions, 12 required evidence fields, 3 target outcome metrics, and zero-count baselines.
...
- Added deterministic report verification guardrails and 149 passing CI tests.

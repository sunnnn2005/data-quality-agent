...
- Added a CI-verified recruiter pitch artifact with 3 resume bullets, LinkedIn project description, 30-second pitch, interview talking points, and 19 evidence links.
...
- Added deterministic report verification guardrails and 120 passing CI tests.

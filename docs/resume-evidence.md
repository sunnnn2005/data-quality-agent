...
| `community-growth-baseline` | CI-verified community growth baseline | [Community growth baseline](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/community-growth-baseline.json) | The project verifies 7 issue templates, 7 configured labels, 8 public contribution or feedback channels, contribution guidance, public feedback entrypoints, and current public counts without claiming community adoption. |
...
| `public-traction-dashboard` | CI-verified public traction dashboard | [Public traction dashboard](https://raw.githubusercontent.com/sunnnn2005/data-quality-agent/main/docs/public-traction-dashboard.json) | The project tracks 4 live project surfaces, 18 growth or review channels, 5 demo funnel steps, and 3 resume-upgrade rules without inflating current traction. |
...
- Added a CI-verified community growth baseline with 7 issue templates, 7 configured labels, 8 public contribution or feedback channels, contribution guidance, and honest current public counts.
...
- Added a CI-verified public traction dashboard with 4 live project surfaces, 18 growth or review channels, 5 tracked demo funnel steps, and 3 resume-upgrade rules.
...
- Added a CI-verified live project scorecard with 18 reviewer paths for the demo, resume evidence, impact packet, business problem casebook, traction dashboard, feedback intake quality, business-data replay packet, OpenAPI contract, safety boundaries, agent capability matrix, local reviewer demo, external-run quickstart, external-run evidence packet, external reviewer outreach tracker, public metrics, and reviewer funnel board.
...
- Added a CI-verified recruiter pitch artifact with 3 resume bullets, LinkedIn project description, 30-second pitch, interview talking points, and 18 evidence links.
- Added a CI-verified application evidence pack with 22 recruiter review links, verified outcome numbers, resume bullets, an email note, and an interview opening.
...
- Added a CI-verified real-model runbook with 4 run commands, 15 evidence fields, 8 acceptance criteria, and 5 safety gates without claiming a paid model run yet.
...
- Added deterministic report verification guardrails and 117 passing CI tests.

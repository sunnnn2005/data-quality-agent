...
Public, containerized LLM data-quality agent with CI-verified evidence artifacts, 70 tests, 30 verified resume claims, and honest adoption baselines.
...
- Published a public demo, v0.2.0 release, GHCR container image, and CI-verified live project scorecard with 70 passing tests, 30 verified resume claims, and 14 implemented LLM agent-readiness capabilities.

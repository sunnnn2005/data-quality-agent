...
Public, containerized LLM data-quality agent with CI-verified evidence artifacts, 248 tests, 96 verified resume claims, and honest adoption baselines.
...
- Published a public demo, v0.3.0 release, GHCR container image, and CI-verified live project scorecard with 248 passing tests, 96 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

...
Public, containerized LLM data-quality agent with CI-verified evidence artifacts, 69 tests, 29 verified resume claims, and honest adoption baselines.
...
| --- | ---: |
| Passing Tests | 69 |
| Verified Resume Claims | 29 |
| Implemented Agent Capabilities | 14 |
| Agent Tools Allowed | 5 |
...
- Published a public demo, v0.2.0 release, GHCR container image, and CI-verified live project scorecard with 69 passing tests, 29 verified resume claims, and 14 implemented LLM agent-readiness capabilities.

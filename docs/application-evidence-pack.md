...
Public, containerized LLM data-quality agent with CI-verified evidence artifacts, 79 tests, 38 verified resume claims, and honest adoption baselines.
...
- Published a public demo, v0.2.0 release, GHCR container image, and CI-verified live project scorecard with 79 passing tests, 38 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

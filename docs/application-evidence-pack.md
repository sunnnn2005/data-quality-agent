...
Public, containerized LLM data-quality agent with CI-verified evidence artifacts, 73 tests, 32 verified resume claims, and honest adoption baselines.
...
| --- | ---: |
| Passing Tests | 73 |
| Verified Resume Claims | 32 |
| Implemented Agent Capabilities | 15 |
| Agent Tools Allowed | 6 |

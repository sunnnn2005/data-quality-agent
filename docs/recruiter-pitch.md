...
- Published a public demo, v0.3.0 release, GHCR container image, and CI-verified live project scorecard with 107 passing tests, 59 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

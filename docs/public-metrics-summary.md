...
| External run evidence packet | 1 |
...
| External reviewer evidence gate rules | 10 |
...
| Reviewer submission target metrics | 7 |
...
| Public reviewer call submission paths | 7 |
...
- External reviewer evidence gate with 10 validation rules, 15 collected public GitHub issues, 3 linked outreach queue entries, 0 accepted public reviewer issues, and sensitive-data safeguards
...
- Reviewer share kit with 5 copy-ready messages, 5 share channels, issue #19, 7 submission paths, and zero sent or completed outreach claimed

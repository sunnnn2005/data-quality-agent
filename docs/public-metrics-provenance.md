...
| passing_tests | 209 | pytest collection and CI evidence via update_adoption_metrics.py | `claimable` | May claim passing test count after local and CI verification. |

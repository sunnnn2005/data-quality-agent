...
Live project scorecard: public demo, v0.2.0 release, container image, 67 passing CI tests, 27 verified resume claims, and 14 implemented LLM agent-readiness capabilities.

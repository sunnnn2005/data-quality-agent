...
Live project scorecard: public demo, v0.3.0 release, container image, 90 passing CI tests, 49 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

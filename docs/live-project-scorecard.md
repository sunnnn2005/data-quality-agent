...
Live project scorecard: public demo, v0.3.0 release, container image, 168 passing CI tests, 84 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

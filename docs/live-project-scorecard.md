...
Live project scorecard: public demo, v0.2.0 release, container image, 76 passing CI tests, 34 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

...
Live project scorecard: public demo, v0.2.0 release, container image, 73 passing CI tests, 32 verified resume claims, and 15 implemented LLM agent-readiness capabilities.

...
Live project scorecard: public demo, v0.2.0 release, container image, 85 passing CI tests, 44 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

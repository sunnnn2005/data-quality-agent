...
Live project scorecard: public demo, v0.3.0 release, container image, 136 passing CI tests, 70 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

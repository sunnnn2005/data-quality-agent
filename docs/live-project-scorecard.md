...
Live project scorecard: public demo, v0.2.0 release, container image, 79 passing CI tests, 38 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

...
Live project scorecard: public demo, v0.3.0 release, container image, 243 passing CI tests, 96 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

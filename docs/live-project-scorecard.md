...
Live project scorecard: public demo, v0.2.0 release, container image, 84 passing CI tests, 43 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

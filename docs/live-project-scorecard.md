...
Live project scorecard: public demo, v0.2.0 release, container image, 69 passing CI tests, 29 verified resume claims, and 14 implemented LLM agent-readiness capabilities.

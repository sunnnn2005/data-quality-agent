...
Live project scorecard: public demo, v0.3.0 release, container image, 226 passing CI tests, 95 verified resume claims, and 16 implemented LLM agent-readiness capabilities.

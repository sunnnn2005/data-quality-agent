...
1. Open the [first external proof action sheet](https://sunnnn2005.github.io/data-quality-agent/first-external-proof-action-sheet.html), [2-minute review card](https://sunnnn2005.github.io/data-quality-agent/two-minute-review-card.html), [business pilot offer](https://sunnnn2005.github.io/data-quality-agent/business-pilot-offer.html), [public demo](https://sunnnn2005.github.io/data-quality-agent/), or the [external run quickstart](https://sunnnn2005.github.io/data-quality-agent/external-run-quickstart.html).
...
| --- | --- | --- | --- |
| AI Engineer review | AI engineer, ML systems reviewer, mentor, or advanced CS/data science peer | [First AI reviewer ask](https://sunnnn2005.github.io/data-quality-agent/first-ai-reviewer-ask.html) | Public issue from `ai_engineer_review.md` with permission to count |
...
| Outcome collection page | [`docs/outcome-collection.html`](docs/outcome-collection.html) gives reviewers one public page for 6 next actions, 7 submission paths, 32 evidence fields, and current zero-count outcome baselines |
...
| Public outcome intake dashboard | [`docs/public-outcome-intake-dashboard.html`](docs/public-outcome-intake-dashboard.html) separates 4 claimable public proof signals from 5 blocked external-outcome intake paths, each with a public evidence submission URL |
...
| First external proof action sheet | [`docs/first-external-proof-action-sheet.html`](docs/first-external-proof-action-sheet.html) gives today-ready outreach order, 3 prioritized reviewer targets, 3 copy-ready asks, recorder commands, and strict zero-claim boundaries |
...
| Test suite | 252 automated tests passing locally and in GitHub Actions |
...
| Public traction dashboard | [`docs/public-traction-dashboard.md`](docs/public-traction-dashboard.md) tracks 4 live project surfaces, 21 growth or review channels, 5 demo funnel steps, and resume-upgrade thresholds |
...
| Public availability snapshot | [`docs/public-availability-snapshot.md`](docs/public-availability-snapshot.md) captures reachable public endpoints, deployment evidence, and recent main-branch workflow health without claiming production uptime or users |
...
| Business impact validation plan | [`docs/business-impact-validation-plan.md`](docs/business-impact-validation-plan.md) maps 5 pilot metrics to external evidence requirements so future business-impact claims require non-owner public validation |
...
| Reviewer submission hub | [`docs/reviewer-submission-hub.md`](docs/reviewer-submission-hub.md) maps 7 outcome metrics to public submission paths, 32 required evidence fields, and conservative counting rules for future reviewer evidence |
| Public reviewer call | [`docs/public-reviewer-call.md`](docs/public-reviewer-call.md) opens a public call for 3 reviewer segments, 7 submission paths, and 32 evidence fields without claiming outcomes yet |
...
| Reviewer outcome sprint calendar | [`docs/reviewer-outcome-sprint-calendar.md`](docs/reviewer-outcome-sprint-calendar.md) turns the reviewer send queue into a 7-day execution calendar with 5 prioritized sends, 5 target metrics, and gate-based resume unlock criteria |
| Reviewer outcome ledger | [`docs/reviewer-outcome-ledger.md`](docs/reviewer-outcome-ledger.md) joins outreach status, public issue submissions, accepted evidence, and exact future resume wording across 5 reviewer outcome goals without upgrading zero-evidence claims |
| Reviewer action queue | [`docs/reviewer-action-queue.md`](docs/reviewer-action-queue.md) turns the feedback goal into 9 concrete outreach tasks mapped to 6 evidence goals, including accepted real-model run evidence, with zero contacted or completed reviews claimed |
| Reviewer outreach execution pack | [`docs/reviewer-outreach-execution-pack.md`](docs/reviewer-outreach-execution-pack.md) turns the action queue into 9 ready-to-send messages, 9 follow-up rules, 6 evidence goals, and a zero sent/completed baseline |
| Reviewer outreach status board | [`docs/reviewer-outreach-status-board.md`](docs/reviewer-outreach-status-board.md) tracks 9 reviewer slots across 5 status stages, reading real events from `docs/reviewer-outreach-events.json` while keeping accepted-evidence and resume-upgrade claims at zero |
...
| Outcome launch day tracker | [`docs/outcome-launch-day-tracker.md`](docs/outcome-launch-day-tracker.md) turns the first 5 reviewer sends into a day-of-execution checklist with copy-ready messages, record-after-sending commands, first resume unlock status, and zero outcome claims |
| First outcome evidence request | [`docs/first-outcome-evidence-request.html`](docs/first-outcome-evidence-request.html) gives one sendable public AI Engineer review request with 6 inspection targets, 5 prompts, required evidence fields, and a locked future resume line while preserving 0 accepted evidence |
...
| LLM value comparison | [`docs/llm-value-comparison.md`](docs/llm-value-comparison.md) compares a fixed generic checklist against adaptive strategy selection across 14 scenarios, improving finding recall from 0.417 to 1.0 without claiming paid-model benchmarks or external adoption |
...
| Real model run request pack | [`docs/real-model-run-request-pack.md`](docs/real-model-run-request-pack.md) gives reviewers a privacy-safe issue template, 5 evidence links, 8 acceptance conditions, and 4 resume unlocks for collecting an accepted real LLM run without exposing secrets |
...
| First accepted evidence examples | [`docs/first-accepted-evidence-examples.md`](docs/first-accepted-evidence-examples.md) shows 2 gate-tested passing examples and 2 rejected examples so reviewers know what unlocks business-case and real-model-run resume evidence without changing real counts |
...
| Community growth baseline | [`docs/community-growth-baseline.md`](docs/community-growth-baseline.md) verifies 9 issue templates, 12 labels, 11 public contribution or feedback channels, and honest current public counts |

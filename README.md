...
| Test suite | 56 automated tests passing locally and in GitHub Actions |
...
| Agent readiness | [`docs/agent-readiness.md`](docs/agent-readiness.md) separates implemented LLM agent capabilities from partial memory, RAG, observability, and evaluation work |

...
| Test suite | 135 automated tests passing locally and in GitHub Actions |
...
| Application evidence pack | [`docs/application-evidence-pack.md`](docs/application-evidence-pack.md) gives recruiters 29 review links, verified outcome numbers, resume bullets, an email note, and an interview opening |

...
| Test suite | 112 automated tests passing locally and in GitHub Actions |
...
| External run evidence packet | [`docs/external-run-evidence-packet.md`](docs/external-run-evidence-packet.md) defines 3 reviewer run paths, 8 required submission fields, 3 resume-upgrade rules, and privacy boundaries for future public run evidence |

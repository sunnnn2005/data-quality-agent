...
| Test suite | 114 automated tests passing locally and in GitHub Actions |
...
| Public traction dashboard | [`docs/public-traction-dashboard.md`](docs/public-traction-dashboard.md) tracks 4 live project surfaces, 17 growth or review channels, 5 demo funnel steps, and resume-upgrade thresholds |
...
| Star growth kit | [`docs/star-growth-kit.md`](docs/star-growth-kit.md) verifies 6 repo topics, 4 ethical growth actions, 3 resume-upgrade rules, and the current 0-star baseline |
...
| Application evidence pack | [`docs/application-evidence-pack.md`](docs/application-evidence-pack.md) gives recruiters 20 review links, verified outcome numbers, resume bullets, an email note, and an interview opening |
...
| Agent capability matrix | [`docs/agent-capability-matrix.md`](docs/agent-capability-matrix.md) maps the project against a practical LLM-agent checklist with 13 implemented capabilities, 4 partial maturity areas, 7 allowed tools, and explicit not-claimed production adoption |
| Real model runbook | [`docs/real-model-runbook.md`](docs/real-model-runbook.md) defines 4 run commands, 15 evidence fields, 8 acceptance criteria, and 5 safety gates for future OpenAI-compatible tool-calling evidence without claiming a paid model run yet |
...
| External run evidence packet | [`docs/external-run-evidence-packet.md`](docs/external-run-evidence-packet.md) links public issue [#18](https://github.com/sunnnn2005/data-quality-agent/issues/18) and defines 3 reviewer run paths, 8 required submission fields, 3 resume-upgrade rules, and privacy boundaries for future public run evidence |
| External reviewer request pack | [`docs/external-reviewer-request-pack.md`](docs/external-reviewer-request-pack.md) provides 3 copy-ready outreach messages tied to issue [#18](https://github.com/sunnnn2005/data-quality-agent/issues/18), 3 run paths, 8 evidence fields, and zero-count baselines |
...
| Community growth baseline | [`docs/community-growth-baseline.md`](docs/community-growth-baseline.md) verifies 6 issue templates, 7 labels, 7 public contribution or feedback channels, and honest current public counts |

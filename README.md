...
| Test suite | 89 automated tests passing locally and in GitHub Actions |
...
| Community growth baseline | [`docs/community-growth-baseline.md`](docs/community-growth-baseline.md) verifies 4 issue templates, 5 labels, 5 public contribution or feedback channels, and honest current public counts |

...
[Public demo](https://sunnnn2005.github.io/data-quality-agent/) · [Support-ticket case study](docs/support-ticket-case-study.md) · [Verified JSON](docs/verified-support-ticket-result.json) · [Feedback](https://github.com/sunnnn2005/data-quality-agent/issues/new?template=demo_feedback.md) · [API docs after local start](http://127.0.0.1:8000/docs)

...
| Test suite | 95 automated tests passing locally and in GitHub Actions |
...
| Business data replay packet | [`docs/business-data-replay-packet.md`](docs/business-data-replay-packet.md) gives reviewers 3 safe replay paths, 8 evidence fields, and 5 safety requirements for collecting confirmed run evidence without claiming external replay yet |

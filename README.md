...
[Public demo](https://sunnnn2005.github.io/data-quality-agent/) · [v0.1.0 release notes](docs/releases/v0.1.0.md) · [Support-ticket case study](docs/support-ticket-case-study.md) · [Verified JSON](docs/verified-support-ticket-result.json) · [Adoption metrics](docs/adoption-metrics.json) · [Feedback](https://github.com/sunnnn2005/data-quality-agent/issues/new?template=demo_feedback.md) · [API docs after local start](http://127.0.0.1:8000/docs)
...
| Test suite | 42 automated tests passing locally and in GitHub Actions |
